    ...
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav side-nav" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="#" style="margin-left: 20px;">Report</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#" style="margin-left: 20px;">Notification</a>
          </li>
          <!-- <li class="nav-item">
        ...
        <ul class="navbar-nav ml-md-auto d-md-flex">
          <li class="nav-item">
            <a class="nav-link" href="receptionisthome.php">Home
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
